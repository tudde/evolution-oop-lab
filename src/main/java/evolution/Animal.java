...
public class Animal implements IMapElement {
    ...
    private final int[] genome; // przydałaby się osobna klasa
    ...
    public void unalive(int day) { // nie ma takiego słowa
        status = "Dead";
        dayDied = day;
    }
    ...
    public Animal breed(Animal other) {
        ...
        if (side == 0) {
            ...
            for (int i = 0; i < genesFromOther; i++) {  // https://docs.oracle.com/javase/7/docs/api/java/lang/System.html#arraycopy(java.lang.Object,%20int,%20java.lang.Object,%20int,%20int)
                newGenome[j] = other.genome[i];
                j++;
            }
    ...
    private void notifyPositionObservers(Vector2d newPosition) {
        for (IPositionChangeObserver o : observers) {
            o.positionChanged(this, newPosition); // positionChange*d* - zwierzę już powinno mieć nową pozycję
        }
    }
